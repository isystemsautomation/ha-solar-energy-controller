...
CONSUMER_THRESHOLD_W = "threshold_w"
CONSUMER_ASSUMED_POWER_W = "assumed_power_w"
CONSUMER_STEP_W = "step_w"
CONSUMER_PID_DEADBAND_PCT = "pid_deadband_pct"
CONSUMER_DEFAULT_START_DELAY_S = 60.0
CONSUMER_DEFAULT_STOP_DELAY_S = 300.0
CONSUMER_DEFAULT_THRESHOLD_W = 600.0
CONSUMER_MIN_THRESHOLD_W = 0.0
CONSUMER_MAX_THRESHOLD_W = 20000.0
CONSUMER_DEFAULT_ASSUMED_POWER_W = 0.0
CONSUMER_MIN_ASSUMED_POWER_W = 0.0
CONSUMER_MAX_ASSUMED_POWER_W = 20000.0
CONSUMER_DEFAULT_STEP_W = 200.0
CONSUMER_MIN_STEP_W = 10.0
CONSUMER_MAX_STEP_W = 2000.0
CONSUMER_DEFAULT_PID_DEADBAND_PCT = 3.0
CONSUMER_MIN_PID_DEADBAND_PCT = 0.0
CONSUMER_MAX_PID_DEADBAND_PCT = 20.0
...
CONF_DIVIDER_ENABLED = "divider_enabled"
...
DIVIDER_STATE_DISABLED = "DISABLED"
DIVIDER_STATE_IDLE = "IDLE"
DIVIDER_STATE_ACTIVE = "ACTIVE"
DIVIDER_STATE_WAITING_START_TIMER = "WAITING_START_TIMER"
DIVIDER_STATE_WAITING_STOP_TIMER = "WAITING_STOP_TIMER"
